...
Node* BatchFFT(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchFFT";
  return UnaryOp(kOpName, input, opts);
}

Node* BatchFFT2D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchFFT2D";
  return UnaryOp(kOpName, input, opts);
}

Node* BatchFFT3D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchFFT3D";
  return UnaryOp(kOpName, input, opts);
}

Node* BatchIFFT(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchIFFT";
  return UnaryOp(kOpName, input, opts);
}

Node* BatchIFFT2D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchIFFT2D";
  return UnaryOp(kOpName, input, opts);
}

Node* BatchIFFT3D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "BatchIFFT3D";
  return UnaryOp(kOpName, input, opts);
}
...
Node* Conj(NodeOut input, const GraphDefBuilder::Options& opts) {
...
Node* FFT(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "FFT";
  return UnaryOp(kOpName, input, opts);
}

Node* FFT2D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "FFT2D";
  return UnaryOp(kOpName, input, opts);
}

Node* FFT3D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "FFT3D";
  return UnaryOp(kOpName, input, opts);
}
...
Node* IFFT(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "IFFT";
  return UnaryOp(kOpName, input, opts);
}

Node* IFFT2D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "IFFT2D";
  return UnaryOp(kOpName, input, opts);
}

Node* IFFT3D(NodeOut input, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "IFFT3D";
  return UnaryOp(kOpName, input, opts);
}

Node* Igamma(NodeOut a, NodeOut x, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "Igamma";
  return BinaryOp(kOpName, a, x, opts);
}

Node* Igammac(NodeOut a, NodeOut x, const GraphDefBuilder::Options& opts) {
  static const string kOpName = "Igammac";
  return BinaryOp(kOpName, a, x, opts);
}

Node* Imag(NodeOut input, const GraphDefBuilder::Options& opts) {
...
Node* Real(NodeOut input, const GraphDefBuilder::Options& opts) {
