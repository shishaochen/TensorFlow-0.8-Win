...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fsummary_2eproto() {
  ...
  static const int Summary_Value_offsets_[7] = {
...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fsummary_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "t\030\006 \003(\001B\002\020\001\022\022\n\006bucket\030\007 \003(\001B\002\020\001\"\361\003\n\007Summ"
    ...
    "\022\024\n\014content_type\030\005 \001(\t\032\342\001\n\005Value\022\013\n\003tag\030"
    ...
    "\rSummaryProtosP\001b\006proto3", 744);
...
Summary_Audio* Summary_Audio::New(::google::protobuf::Arena* arena) const {
  Summary_Audio* n = new Summary_Audio;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
// @@protoc_insertion_point(class_specific_merge_from_start:tensorflow.Summary.Audio)
  ...
  if (from.encoded_audio_string().size() > 0) {
    ...
    encoded_audio_string_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.encoded_audio_string_);
  }
...
void Summary_Audio::clear_encoded_audio_string() {
 ...
 void Summary_Audio::set_encoded_audio_string(const void* value, size_t size) {
...
void Summary_Audio::clear_content_type() {
 ...
 void Summary_Audio::set_content_type(const char* value, size_t size) {
