...
class CostGraphDef_Node : public ::google::protobuf::Message {
 public:
  ...
  static const int kInputInfoFieldNumber = 3;
  ...
  static const int kOutputInfoFieldNumber = 4;
  ...
  static const int kTemporaryMemorySizeFieldNumber = 5;
  ...
  void clear_is_final();
  static const int kIsFinalFieldNumber = 6;
  bool is_final() const;
