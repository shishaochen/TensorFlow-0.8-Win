...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fcost_5fgraph_2eproto() {
  ...
  static const int CostGraphDef_Node_offsets_[6] = {
...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2fcost_5fgraph_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "roto\022\ntensorflow\"\376\002\n\014CostGraphDef\022+\n\004nod"
    "e\030\001 \003(\0132\035.tensorflow.CostGraphDef.Node\032\300"
    "\002\n\004Node\022\014\n\004name\030\001 \001(\t\022\n\n\002id\030\002 \001(\005\022;\n\ninp"
    "ut_info\030\003 \003(\0132\'.tensorflow.CostGraphDef."
    "Node.InputInfo\022=\n\013output_info\030\004 \003(\0132(.te"
    "nsorflow.CostGraphDef.Node.OutputInfo\022\035\n"
    "\025temporary_memory_size\030\005 \001(\003\022\020\n\010is_final"
    "\030\006 \001(\010\032;\n\tInputInfo\022\026\n\016preceding_node\030\001 "
    "\001(\005\022\026\n\016preceding_port\030\002 \001(\005\0324\n\nOutputInf"
    "o\022\014\n\004size\030\001 \001(\003\022\030\n\020alias_input_port\030\002 \001("
    "\003B-\n\030org.tensorflow.frameworkB\017CostGraph"
    "ProtosP\001b\006proto3", 496);
...
CostGraphDef_Node_InputInfo* CostGraphDef_Node_InputInfo::New(::google::protobuf::Arena* arena) const {
  CostGraphDef_Node_InputInfo* n = new CostGraphDef_Node_InputInfo;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
CostGraphDef_Node_OutputInfo* CostGraphDef_Node_OutputInfo::New(::google::protobuf::Arena* arena) const {
  CostGraphDef_Node_OutputInfo* n = new CostGraphDef_Node_OutputInfo;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
CostGraphDef_Node* CostGraphDef_Node::New(::google::protobuf::Arena* arena) const {
  CostGraphDef_Node* n = new CostGraphDef_Node;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_input_info;
        break;
      }

      // repeated .tensorflow.CostGraphDef.Node.InputInfo input_info = 3;
      case 3: {
        if (tag == 26) {
         parse_input_info:
        ...
        if (input->ExpectTag(26)) goto parse_loop_input_info;
        if (input->ExpectTag(34)) goto parse_loop_output_info;
        input->UnsafeDecrementRecursionDepth();
        break;
      }

      // repeated .tensorflow.CostGraphDef.Node.OutputInfo output_info = 4;
      case 4: {
        if (tag == 34) {
          DO_(input->IncrementRecursionDepth());
        ...
        if (input->ExpectTag(34)) goto parse_loop_output_info;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(40)) goto parse_temporary_memory_size;
        break;
      }

      // optional int64 temporary_memory_size = 5;
      case 5: {
        if (tag == 40) {
        ...
        if (input->ExpectTag(48)) goto parse_is_final;
        break;
      }
...
void CostGraphDef_Node::SerializeWithCachedSizes(
  ...
  for (unsigned int i = 0, n = this->input_info_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->input_info(i), output);
  }

  // repeated .tensorflow.CostGraphDef.Node.OutputInfo output_info = 4;
  for (unsigned int i = 0, n = this->output_info_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->output_info(i), output);
  }

  // optional int64 temporary_memory_size = 5;
  if (this->temporary_memory_size() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(5, this->temporary_memory_size(), output);
  }

  // optional bool is_final = 6;
  if (this->is_final() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(6, this->is_final(), output);
  }
...
::google::protobuf::uint8* CostGraphDef_Node::SerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->output_info_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        4, this->output_info(i), target);
  }

  // optional int64 temporary_memory_size = 5;
  if (this->temporary_memory_size() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(5, this->temporary_memory_size(), target);
  }

  // optional bool is_final = 6;
  if (this->is_final() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(6, this->is_final(), target);
  }
...
CostGraphDef* CostGraphDef::New(::google::protobuf::Arena* arena) const {
  CostGraphDef* n = new CostGraphDef;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void CostGraphDef_Node::clear_name() {
 ...
 void CostGraphDef_Node::set_name(const char* value, size_t size) {
