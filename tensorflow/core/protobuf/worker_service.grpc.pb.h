 ...
 public:
  ...
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status GetStatus(::grpc::ClientContext* context, const ::tensorflow::GetStatusRequest& request, ::tensorflow::GetStatusResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status RegisterGraph(::grpc::ClientContext* context, const ::tensorflow::RegisterGraphRequest& request, ::tensorflow::RegisterGraphResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status DeregisterGraph(::grpc::ClientContext* context, const ::tensorflow::DeregisterGraphRequest& request, ::tensorflow::DeregisterGraphResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status RunGraph(::grpc::ClientContext* context, const ::tensorflow::RunGraphRequest& request, ::tensorflow::RunGraphResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status CleanupGraph(::grpc::ClientContext* context, const ::tensorflow::CleanupGraphRequest& request, ::tensorflow::CleanupGraphResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status CleanupAll(::grpc::ClientContext* context, const ::tensorflow::CleanupAllRequest& request, ::tensorflow::CleanupAllResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status RecvTensor(::grpc::ClientContext* context, const ::tensorflow::RecvTensorRequest& request, ::tensorflow::RecvTensorResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status Logging(::grpc::ClientContext* context, const ::tensorflow::LoggingRequest& request, ::tensorflow::LoggingResponse* response) GRPC_OVERRIDE;
    ...
    ::grpc::Status Tracing(::grpc::ClientContext* context, const ::tensorflow::TracingRequest& request, ::tensorflow::TracingResponse* response) GRPC_OVERRIDE;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::tensorflow::GetStatusResponse>* AsyncGetStatusRaw(::grpc::ClientContext* context, const ::tensorflow::GetStatusRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::RegisterGraphResponse>* AsyncRegisterGraphRaw(::grpc::ClientContext* context, const ::tensorflow::RegisterGraphRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::DeregisterGraphResponse>* AsyncDeregisterGraphRaw(::grpc::ClientContext* context, const ::tensorflow::DeregisterGraphRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::RunGraphResponse>* AsyncRunGraphRaw(::grpc::ClientContext* context, const ::tensorflow::RunGraphRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::CleanupGraphResponse>* AsyncCleanupGraphRaw(::grpc::ClientContext* context, const ::tensorflow::CleanupGraphRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::CleanupAllResponse>* AsyncCleanupAllRaw(::grpc::ClientContext* context, const ::tensorflow::CleanupAllRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::RecvTensorResponse>* AsyncRecvTensorRaw(::grpc::ClientContext* context, const ::tensorflow::RecvTensorRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::LoggingResponse>* AsyncLoggingRaw(::grpc::ClientContext* context, const ::tensorflow::LoggingRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::TracingResponse>* AsyncTracingRaw(::grpc::ClientContext* context, const ::tensorflow::TracingRequest& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
  ...
  class WithAsyncMethod_GetStatus : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_GetStatus() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetStatus(::grpc::ServerContext* context, const ::tensorflow::GetStatusRequest* request, ::tensorflow::GetStatusResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
  ...
  class WithAsyncMethod_RegisterGraph : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_RegisterGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RegisterGraph(::grpc::ServerContext* context, const ::tensorflow::RegisterGraphRequest* request, ::tensorflow::RegisterGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_DeregisterGraph : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_DeregisterGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DeregisterGraph(::grpc::ServerContext* context, const ::tensorflow::DeregisterGraphRequest* request, ::tensorflow::DeregisterGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_RunGraph : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_RunGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RunGraph(::grpc::ServerContext* context, const ::tensorflow::RunGraphRequest* request, ::tensorflow::RunGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CleanupGraph : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_CleanupGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CleanupGraph(::grpc::ServerContext* context, const ::tensorflow::CleanupGraphRequest* request, ::tensorflow::CleanupGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_CleanupAll : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_CleanupAll() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CleanupAll(::grpc::ServerContext* context, const ::tensorflow::CleanupAllRequest* request, ::tensorflow::CleanupAllResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_RecvTensor : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_RecvTensor() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RecvTensor(::grpc::ServerContext* context, const ::tensorflow::RecvTensorRequest* request, ::tensorflow::RecvTensorResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_Logging : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_Logging() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Logging(::grpc::ServerContext* context, const ::tensorflow::LoggingRequest* request, ::tensorflow::LoggingResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  class WithAsyncMethod_Tracing : public BaseClass {
   ...
   public:
    ...
    ~WithAsyncMethod_Tracing() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Tracing(::grpc::ServerContext* context, const ::tensorflow::TracingRequest* request, ::tensorflow::TracingResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
  ...
  typedef WithAsyncMethod_GetStatus<WithAsyncMethod_RegisterGraph<WithAsyncMethod_DeregisterGraph<WithAsyncMethod_RunGraph<WithAsyncMethod_CleanupGraph<WithAsyncMethod_CleanupAll<WithAsyncMethod_RecvTensor<WithAsyncMethod_Logging<WithAsyncMethod_Tracing<Service > > > > > > > > > AsyncService;
  template <class BaseClass>
  class WithGenericMethod_GetStatus : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_GetStatus() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetStatus(::grpc::ServerContext* context, const ::tensorflow::GetStatusRequest* request, ::tensorflow::GetStatusResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_RegisterGraph : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_RegisterGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RegisterGraph(::grpc::ServerContext* context, const ::tensorflow::RegisterGraphRequest* request, ::tensorflow::RegisterGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_DeregisterGraph : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_DeregisterGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DeregisterGraph(::grpc::ServerContext* context, const ::tensorflow::DeregisterGraphRequest* request, ::tensorflow::DeregisterGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_RunGraph : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_RunGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RunGraph(::grpc::ServerContext* context, const ::tensorflow::RunGraphRequest* request, ::tensorflow::RunGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_CleanupGraph : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_CleanupGraph() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CleanupGraph(::grpc::ServerContext* context, const ::tensorflow::CleanupGraphRequest* request, ::tensorflow::CleanupGraphResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_CleanupAll : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_CleanupAll() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CleanupAll(::grpc::ServerContext* context, const ::tensorflow::CleanupAllRequest* request, ::tensorflow::CleanupAllResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_RecvTensor : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_RecvTensor() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RecvTensor(::grpc::ServerContext* context, const ::tensorflow::RecvTensorRequest* request, ::tensorflow::RecvTensorResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_Logging : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_Logging() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Logging(::grpc::ServerContext* context, const ::tensorflow::LoggingRequest* request, ::tensorflow::LoggingResponse* response) GRPC_FINAL GRPC_OVERRIDE {
  ...
  class WithGenericMethod_Tracing : public BaseClass {
   ...
   public:
    ...
    ~WithGenericMethod_Tracing() GRPC_OVERRIDE {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Tracing(::grpc::ServerContext* context, const ::tensorflow::TracingRequest* request, ::tensorflow::TracingResponse* response) GRPC_FINAL GRPC_OVERRIDE {
