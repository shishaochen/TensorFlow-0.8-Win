...
MasterService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_RunStep_(MasterService_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CloseSession_(MasterService_method_names[3], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListDevices_(MasterService_method_names[4], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Reset_(MasterService_method_names[5], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
