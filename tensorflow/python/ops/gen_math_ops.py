...
def batch_fft(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchFFT", input=input, name=name)
...
def batch_fft2d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchFFT2D", input=input, name=name)
...
def batch_fft3d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchFFT3D", input=input, name=name)
...
def batch_ifft(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchIFFT", input=input, name=name)
...
def batch_ifft2d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchIFFT2D", input=input, name=name)
...
def batch_ifft3d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("BatchIFFT3D", input=input, name=name)
...
def conj(input, name=None):
  ...
  Returns:
    A `Tensor` of type `complex64`.
  """
  return _op_def_lib.apply_op("Conj", input=input, name=name)
...
def equal(x, y, name=None):
  ...
  Args:
    x: A `Tensor`. Must be one of the following types: `half`, `float32`, `float64`, `uint8`, `int8`, `int16`, `int32`, `int64`, `complex64`, `quint8`, `qint8`, `qint32`, `string`, `bool`.
    y: A `Tensor`. Must have the same type as `x`.
    name: A name for the operation (optional).
...
def fft2d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("FFT2D", input=input, name=name)
...
def fft3d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("FFT3D", input=input, name=name)
...
def ifft(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("IFFT", input=input, name=name)
...
def ifft2d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("IFFT2D", input=input, name=name)
...
def ifft3d(input, name=None):
  ...
  """
  return _op_def_lib.apply_op("IFFT3D", input=input, name=name)
...
def imag(input, name=None):
  ...
  Returns:
    A `Tensor` of type `float32`.
  """
  return _op_def_lib.apply_op("Imag", input=input, name=name)
...
def real(input, name=None):
  ...
  Returns:
    A `Tensor` of type `float32`.
  """
  return _op_def_lib.apply_op("Real", input=input, name=name)
