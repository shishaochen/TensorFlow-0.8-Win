...
def dequantize(input, min_range, max_range, mode=None, name=None):
  ...
  *MIN_COMBINED Mode Example*
  ...
  """
  return _op_def_lib.apply_op("Dequantize", input=input, min_range=min_range,
...
def quantize_v2(input, min_range, max_range, T, mode=None, name=None):
  ...
  *MIN_COMBINED Mode Example*
  ...
  """
  return _op_def_lib.apply_op("QuantizeV2", input=input, min_range=min_range,
                              max_range=max_range, T=T, mode=mode, name=name)
...
def quantized_concat(concat_dim, values, input_mins, input_maxes, name=None):
  ...
  """
  return _op_def_lib.apply_op("QuantizedConcat", concat_dim=concat_dim,
